        ...
        private void checkBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (sender is CheckBox checkBox)
            {
                if (checkBox.Checked)
                {
                    ...
                    if (today.Day <= 15)
                    {
                        // If in the first half, set the date to the 1st and last day of the *previous* month.
                        ...
                        Logger.LogInfo("CheckBox1 is checked, Date From set to 1st of last month: " + firstDayOfLastMonth + " Date To: " + lastDayOfLastMonth);
                    }
                    else
                    {
                        // Otherwise, set it to the 1st and last day of the *current* month.
                        datepickFrom.Value = firstDayOfMonth;
                        datepickTo.Value = lastDayOfMonth;
                        Logger.LogInfo("CheckBox1 is checked, Date From set to 1st of current month: " + firstDayOfMonth + " Date To: " + lastDayOfMonth);
                    }
                }
                else
                {
                    ...
                    datepickTo.Value = today;
                    Logger.LogInfo("CheckBox1 is unchecked, Date From set to last 15 days: " + fifteenDaysAgo + " Date To: " + today);
                }
            }
            else
            {
