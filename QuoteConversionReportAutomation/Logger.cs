...
namespace QuoteConversionReportAutomation
{
    ...
    /// <summary>
    /// Provides static methods for logging messages to a daily log file, with user-specific directories.
    /// </summary>
    public static class Logger
    {
        ...
        // Static field to store the full log file path.
        ...
        /// <summary>
        /// Static constructor to initialize the logFilePath. This runs only once when the class is first loaded.
        /// </summary>
        static Logger()
        {
            ...
            string dayToday = dateToday.ToString("yyyy-MM-dd");
