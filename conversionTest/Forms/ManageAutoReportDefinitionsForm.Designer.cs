...
namespace QuoteConversionReportAutomation.Forms
{
    partial class ManageAutoReportDefinitionsForm
    {
        ...
        {
            this.components = new System.ComponentModel.Container(); // Added this line to initialize components
            ...
            this.txtRecipientCategoryKey = new System.Windows.Forms.TextBox();
            this.lblRecipientCategoryKey = new System.Windows.Forms.Label();
            this.txtGreetingKey = new System.Windows.Forms.TextBox();
            ...
            this.toolTip1 = new System.Windows.Forms.ToolTip(this.components); // Added ToolTip initialization
        ...
        "abled\' to activate/deactivate a report.");
            ...
            this.grpDefinitionDetails.Controls.Add(this.txtRecipientCategoryKey);
            this.grpDefinitionDetails.Controls.Add(this.lblRecipientCategoryKey);
            this.grpDefinitionDetails.Controls.Add(this.txtGreetingKey);
        ...
        " report).");
            ...
            this.numReportDurationDays.Maximum = new decimal(new int[] {365,0,0,0});
            this.numReportDurationDays.Minimum = new decimal(new int[] {0,0,0,0}); 
        ...
        "");
            this.numReportDurationDays.Value = new decimal(new int[] {1,0,0,0});
            // 
            ...
            this.numReportEndDateOffsetDays.Maximum = new decimal(new int[] {30,0,0,0});
            this.numReportEndDateOffsetDays.Minimum = new decimal(new int[] {0,0,0,0});
        ...
        " previous workday). Set to 0 to use default based on report type.");
            ...
            // 
            // txtRecipientCategoryKey
            // 
            this.txtRecipientCategoryKey.Location = new System.Drawing.Point(130, 153); 
            this.txtRecipientCategoryKey.Name = "txtRecipientCategoryKey";
            this.txtRecipientCategoryKey.Size = new System.Drawing.Size(240, 20);
            this.txtRecipientCategoryKey.TabIndex = 5; 
            this.toolTip1.SetToolTip(this.txtRecipientCategoryKey, "Key to look up email recipients (e.g., AutoRunDailyStandardRecipients). Correspo" +
        "nds to settings in Manage Email Recipients and appsettings.json.");
            // 
            ...
            // txtGreetingKey
            // 
            this.txtGreetingKey.Location = new System.Drawing.Point(130, 127); 
            this.txtGreetingKey.Name = "txtGreetingKey";
            this.txtGreetingKey.Size = new System.Drawing.Size(240, 20);
            this.txtGreetingKey.TabIndex = 4; 
            this.toolTip1.SetToolTip(this.txtGreetingKey, "Key to look up email greeting (e.g., AutoRunDaily). Corresponds to settings in M" +
        "anage Email Greetings and appsettings.json.");
            // 
            // lblGreetingKey
            // 
        ...
        "andardDailyReportSucceeded).");
            ...
            this.chkIsEnabled.Location = new System.Drawing.Point(390, 182); 
        ...
        private System.Windows.Forms.TextBox txtGreetingKey;
        private System.Windows.Forms.Label lblRecipientCategoryKey;
        private System.Windows.Forms.TextBox txtRecipientCategoryKey;
        ...
        private System.Windows.Forms.ToolTip toolTip1; // Added field for ToolTip
    }
}
